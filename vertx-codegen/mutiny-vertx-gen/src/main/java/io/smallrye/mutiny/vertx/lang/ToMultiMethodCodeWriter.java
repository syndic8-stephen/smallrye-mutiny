...
public class ToMultiMethodCodeWriter implements ConditionalCodeWriter {
    ...
    private void genToMulti(TypeInfo type, String fieldName, PrintWriter writer) {
        ...
        if (type.getKind() == ClassKind.API) {
            ...
            writer.print("      ");
            writer.print(fieldName);
            writer.print(" = io.smallrye.mutiny.vertx.helpers.MultiHelper.toMulti(delegate, conv);");
            ...
            writer.print("      ");
            writer.print(fieldName);
            writer.print(" = io.smallrye.mutiny.vertx.helpers.MultiHelper.toMulti(this.getDelegate());");
        }
